...
*
* @editor Kimberley Dawn - http://dreamsofmidnight.com
* @date 08/06/2013
* @version 1.0.1
*
*/
...
SA.redirection_mobile = function(configuration) {
	...
	//Changed if agent to a - KDB
	if (!!(a.match(/(iPad|SCH-I|xoom|NOOK|silk|kindle|GT-P|touchpad|kindle|sch-t|viewpad|bolt|playbook)/i))) {
